...
export function classifyCategory(
   ...
   * SPORTS
   *
   * Strong sports terms can classify a story immediately.
   * Generic words such as team, player, coach and match
   * require additional sporting context.
   */
  ...
  /*
   * Never trust a Sports feed fallback unless the actual
   * story contains genuine sporting evidence.
   */
  if (fallback === 'sports') {
    return 'world'
  }
