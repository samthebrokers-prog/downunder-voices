...
export function AdminEditStoryForm({
  story,
}: {
  story: EditableStory
}) {
  ...
  const input =
    'mt-1 w-full rounded border border-input px-3 py-2 text-sm'

  return (
    <details className="mt-4 rounded border bg-secondary/40 p-3">
      ...
      <form onSubmit={submit} className="mt-4 grid gap-3">
        ...
        <label className="text-sm">
          ...
          <textarea
            name="communityAngle"
            rows={3}
            defaultValue={story.community_angle || ''}
            className={input}
          />
        </label>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <label className="text-sm">
            ...
            <input
              name="sourceName"
              required
              defaultValue={story.source_name}
              className={input}
            />
          </label>
...
export function AdminRunImportButton() {
  ...
  async function run() {
    ...
    setMessage(
      `${total} new stor${total === 1 ? 'y' : 'ies'} imported.`
    )
  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        disabled={working}
        onClick={run}
        className="rounded bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground disabled:opacity-50"
      >
        {working ? 'Importing…' : 'Run news import now'}
      </button>
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        disabled={working}
        onClick={remove}
        className="rounded border border-destructive/40 px-3 py-1.5 text-xs font-semibold text-destructive"
      >
        Delete
      </button>
...
export function AdminNewStoryForm() {
  ...
  return (
    ...
    >
      ...
      <button className="w-fit rounded bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground">
        Save story
      </button>
        ...
        <label className="text-sm">
          ...
          >
            <option value="commercial">
              Commercial — import as draft
            </option>
            <option value="official">
              Official — auto-publish
            </option>
          </select>
        </label>
      </div>
