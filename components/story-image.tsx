...
const categoryImages: Record<string, string[]> = {
  politics: [
    "/news/editorial-australia-public-affairs-2026.jpg",
  ...
  "nz-pacific": [
    "/news/editorial-new-zealand-community-2026.jpg",
...
const keywordGroups: ImageGroup[] = [
...

  {
    ...
    images: [
      "/news/editorial-cost-of-living-2026.jpg",
  ...
  },
  {
    ...
    images: [
      "/news/editorial-trade-logistics-2026.jpg",
...
function selectFallbackPhoto(
  ...
  if (keywordMatch) {
    return selectFromImages(keywordMatch.images, normalisedTitle, imageIndex);
  }

  const categoryKey = normaliseCategory(category);

  const images =
    categoryImages[categoryKey] || categoryImages.default || defaultImages;

  return selectFromImages(images, normalisedTitle, imageIndex);
}
...
export function StoryImage({
  ...
  const fallback = useMemo(
    () => selectFallbackPhoto(alt, category, imageIndex),
  ...
  const finalBackup =
    defaultImages[hashText(`${alt}-${imageIndex ?? 0}`) % defaultImages.length];
