        ...
        <div className="md:col-span-3">
          <div className="space-y-4 text-foreground/90 leading-relaxed">
            <p>
              ...
              stocked, the family navigating the cost of living.
            </p>
            <p>
              We cover politics, business, sport, community and the everyday
              issues shaping life across the region. Alongside the news, our
              opinion column,{' '}
              <span className="font-semibold text-primary">Sam&apos;s View</span>,
              offers honest commentary designed to spark conversation.
            </p>
            <p>
